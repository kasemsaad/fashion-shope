            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo e(route('admin.index')); ?>" aria-current="page">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.users.index')); ?>">Users</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.categories.index')); ?>">Categories</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.hashtags.index')); ?>">Hashtags</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.books.index')); ?>">Books</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.page.index')); ?>">fffff</a>
                        </li>
                    </ul>
...
<?php /**PATH C:\xampp\htdocs\fashion-shop\resources\views/admin/layout/main.blade.php ENDPATH**/ ?>