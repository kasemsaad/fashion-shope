...
<?php $__env->startSection('content'); ?>
    <div class="page-content">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $boo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
        ...
        <?php echo $boo->links('pagination::bootstrap-5'); ?>

    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fashion-shop\resources\views/admin/books/index1.blade.php ENDPATH**/ ?>