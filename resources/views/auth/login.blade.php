...
<head>
  <title>Fashion-Login Page</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"><img src="http://localhost/fashion-shope\public\frontend\img\login.jpeg" alt="Girl in a jacket" width="105%" height="100%">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
