...
@section('main-content')
								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											@endphp
											<td class="image" data-title="No"><img style="width:100% ; height:10rem;" src="{{url($link.$photo[0])}}" ></td>
	...
	<section class="shop-services section pb-5">
		<div class="container">
			<div class="row">
...
@endpush
@push('scripts')
	<script src="{{url('frontend/js/nice-select/js/jquery.nice-select.min.js')}}"></script>
	<script src="{{ url('frontend/js/select2/js/select2.min.js') }}"></script>
	<script>
