...
@section('title','Fashion-Home PAGE')
                                    ...
                                    <div class="single-product">
                                        <div class="product-img ">
                                            <a href="{{route('product-detail',$product->slug)}}">
                                                ...
                                                // dd($photo);
                                                @endphp
                                                <img class="default-img" src="{{url($link.$photo[0])}}"  style="width:100; height:20rem;" >
                                                <img class="hover-img" src="{{url($link.$photo[0])}}" style="width:100; height:20rem;">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a  title="Quick View" href="{{route('product-detail',$product->slug)}}"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                    </a>
                                                </div>
                ...
                @foreach($featured as $data)
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="single-banner">
                            ...
                            @endphp
                            <img src="{{url($link.$photo[0])}}"  style="width:100; height:40rem;">
                            <div class="content">
                    ...
                    @foreach($product_lists as $product)
                        <div class="col-md-4">
                            ...
                            //   dd($link);
                                            ...
                                            // dd($photo);
                                        @endphp
                                        <img src="{{url($link.$photo[0])}}"  style="width:100; height:12rem;">
                                        <a href="{{route('add-to-cart',$product->slug)}}" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                    </div>
                                </div>
                                            ...
                                            <div class="quickview-slider-active">
                                                ...
                                                @endphp
                                                    <div class="single-slider" >
                                                        ...
                                                        <img src="{{url($link.$photo[0])}}"  style="width:100%; height:31.7rem;">
                                                    </div>
                                            </div>
                                        </div>
                                    <!-- End Product slider -->
